	...
	'hexvignette': {
		...
		uniforms: {
			...
			tDiffuse: { 
				type: "t",
				value: 0,
				texture: THREE.ImageUtils.loadTexture('res/hex-test2.jpg', undefined, function(){console.log('ded')})
			},
			tHex: {
				type: "t",
				value: 1,
				texture:  THREE.ImageUtils.loadTexture('res/hex-test2.jpg', undefined, function(){console.log('ded2')})
			},
